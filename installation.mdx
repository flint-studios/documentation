...
**The easiest way (recommended):**<br />This does not install the command on your device permanently and is rather for direct use.

```bash
pipx anchor4git --help
```

> If you don't have `pipx`, install it first: `pip install pipx` <br /><br />Or if you prefer to use `uv` which is faster and better,<br />you can also use `uvx anchor4git --help` 

**Alternative (with installation):**
