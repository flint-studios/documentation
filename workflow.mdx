...
**Step 1:** Open the listed files in your editor.
...
**Step 3:** Edit the file to keep what you want. You can:

- Keep your version (delete the markers and their version)
- Keep their version (delete the markers and your version)
- Mix both versions together

**Step 4:** Remove all the conflict markers (`<<<<<<<`, `=======`, `>>>>>>>`).

**Step 5:** Save the file in your editor.

**Step 6:** Tell Anchor4Git you're done:

```bash
ag save
```

**Step 7:** Share your resolution:
...
# Look around... then press Enter to return
```
...
# 2. Save the initial setup
ag save "Initial project setup"

# 3. Create a shared repository on GitHub, GitLab, etc.
#    (this step depends on your hosting provider)

# 4. Upload the project
ag upload https://github.com/team/my-project.git

# 5. Tell your team to run:
