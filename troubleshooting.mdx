...
**Why it happens:** You used `ag goto --stay` and now you're on an old version. Some commands (save, fetch, upload) can't run while you're in this state.
...
**Why it happens:** You ran `ag upload` but Anchor4Git doesn't know the project address yet.
